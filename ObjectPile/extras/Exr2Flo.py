...
def displayflow(Img, Width, Height, exrfile):
	...
	fig.savefig('/mnt/ddb5152f-7808-4a33-9f27-ba0a0d7f3164/WorldGen/video/annotations/Flow/outputs/'+exrfile, bbox_inches='tight', pad_inches=0)
...
if __name__ == '__main__':
	...
	# parser.add_argument('--flowfile', type=str, default='/mnt/ddb5152f-7808-4a33-9f27-ba0a0d7f3164/WorldGen/video/annotations/Flow/Flow0001.exr', \
	# 						help='Flow file')
	parser.add_argument('--viewflow', type=bool, default=True, \
							help='Flow file')
	# exrfile = parser.parse_args().flowfile
	viewflow = parser.parse_args().viewflow
	folder_dir = '/mnt/ddb5152f-7808-4a33-9f27-ba0a0d7f3164/WorldGen/video/annotations/Flow/'
	for image in os.listdir(folder_dir):
		if "exr" in image:
			main(folder_dir+image, viewflow)
